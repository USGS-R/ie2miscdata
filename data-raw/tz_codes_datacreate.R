...
# Data source \url{http://help.waterdata.usgs.gov/code/tz_query?fmt=html}
# National Water Information System: Help System Time Zone Codes

library(install.load)
load_package("data.table", "rvest") # load needed packages

tz_codes <- read_html("http://help.waterdata.usgs.gov/code/tz_query?fmt=html")
